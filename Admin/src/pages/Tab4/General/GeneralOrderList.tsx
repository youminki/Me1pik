...
import GeneralOrderListTable, { GeneralOrderListItem } from '@/components/Table/GeneralOrderTable';
...
const GeneralOrderList: React.FC = () => {
  ...
  return (
    <Content>
      ...
      <TableContainer>
        <GeneralOrderListTable filteredData={currentPageData} handleEdit={handleEdit} />
      </TableContainer>
